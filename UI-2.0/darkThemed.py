...
class Ui_MainWindow(QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.locationLabel.setStyleSheet("color:#008080;")
        ...
        self.dataLabel.setStyleSheet("color:#008080;")
        ...
        self.focusLabel.setStyleSheet("color:#008080;")
        ...
        self.statusLabel.setStyleSheet("color:#008080;")
        ...
        self.detectionLabel.setStyleSheet("color:#008080;")
        ...
        self.progressLabel.setStyleSheet("color:#008080;")
        ...
        self.highLabel.setStyleSheet("color:#008080;")
        ...
        self.moderateLabel.setStyleSheet("color:#008080;")
        ...
        self.lowLabel.setStyleSheet("color:#008080;")
        ...
        self.filamentLabel.setStyleSheet("color:#008080;")
        ...
        self.fragmentLabel.setStyleSheet("color:#008080;")
        ...
        self.filmLabel.setStyleSheet("color:#008080;")
        ...
        self.detectButton.setStyleSheet("QPushButton {\n""background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #4527A0, stop:1 #1A1A1A);\n""    color: #E0E0E0;\n""    font: bold 16px;\n""    border-radius: 0px;\n""    border-color: #FFFFFF;\n""}\n""QPushButton:hover {\n""    color: #000000;\n""}")
        ...
        self.grblUP.setStyleSheet(u"QPushButton {\n""background-color: qconicalgradient(cx:0.5, cy:0, angle:90.9, stop:0 #1A1A1A, stop:0.37223 #1A1A1A, stop:0.373991 #008080, stop:0.62362 #008080, stop:0.624043 #1A1A1A, stop:1 #1A1A1A);\n""    color: #FFFFFF;\n""    font: bold 16px;\n""    border-radius: 1px;\n""    border-color: #fbbf16;\n""}\n""QPushButton:hover {\n""    background-color: #03DAC5;\n""}")
        self.grblDOWN.setStyleSheet(u"QPushButton {\n""background-color: qconicalgradient(cx:0.494318, cy:1, angle:270, stop:0 #1A1A1A, stop:0.373989 #1A1A1A, stop:0.373991 #008080, stop:0.623986 #008080, stop:0.624043 #1A1A1A, stop:1 #1A1A1A);\n""    color: #FFFFFF;\n""    font: bold 16px;\n""    border-radius: 1px;\n""    border-color: #fbbf16;\n""}\n""QPushButton:hover {\n""    background-color:#03DAC5;\n""}")
        self.grblLEFT.setStyleSheet(u"QPushButton {\n""background-color: qconicalgradient(cx:0, cy:0.499, angle:180.1, stop:0 #1A1A1A, stop:0.375488 #1A1A1A, stop:0.375911 #008080, stop:0.622911 #008080, stop:0.624043 #1A1A1A, stop:1 #1A1A1A);\n""    color: #FFFFFF;\n""    font: bold 16px;\n""    border-radius: 1px;\n""    border-color: #fbbf16;\n""}\n""QPushButton:hover {\n""    background-color: #03DAC5;\n""}")
        self.grblRIGHT.setStyleSheet(u"QPushButton {\n""background-color: qconicalgradient(cx:1, cy:0.499, angle:0.110478, stop:0 #1A1A1A, stop:0.373989 #1A1A1A, stop:0.373991 #008080, stop:0.623986 #008080, stop:0.624043 #1A1A1A, stop:1 #1A1A1A);\n""    color: #FFFFFF;\n""    font: bold 16px;\n""    border-radius: 1px;\n""    border-color: #fbbf16;\n""}\n""QPushButton:hover {\n""    background-color: #03DAC5;\n""}")
        ...
        self.menubar.setStyleSheet("background-color:  #E0E0E0;")
        self.menubar.setObjectName("menubar")
        self.menuFile = QtWidgets.QMenu(self.menubar)
        self.menuFile.setStyleSheet("selection-background-color:  #E0E0E0;\n""selection-color: #000000;")
        self.menuFile.setObjectName("menuFile")
        self.menuEdit = QtWidgets.QMenu(self.menubar)
        self.menuEdit.setStyleSheet("selection-background-color: #E0E0E0;\n""selection-color: #000000;")
